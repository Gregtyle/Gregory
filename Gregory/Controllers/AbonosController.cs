...
namespace Gregory.Controllers
{
    public class AbonosController : Controller
    {
        ...
        public AbonosController(MedellinSalvajeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdAbono,IdReserva,FechaAbono,Valordeuda,Porcentaje,Subtotal,Iva,Total,CantidadAbono,Estado")] Abono abono)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAbono,IdReserva,FechaAbono,Valordeuda,Porcentaje,Subtotal,Iva,Total,CantidadAbono,Estado")] Abono abono)
        {
            if (id != abono.IdAbono)
            {
                return NotFound();
